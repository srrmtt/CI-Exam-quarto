...
class Quarto(object):
    ...
    # def avaliable_pieces(self):
    #     return set([e for e in range(16)]) - set([e for e in self.__board.ravel() if e != -1])
    ...
    def run(self) -> int:
        ...
        '''
        winner = -1
        self.__current_player = random.choice([0,1])
